...
class App extends Component {
  state = {tabId: projectsList[0].category}
  ...
  updatedList = () => {
    ...
    const filterdList = projectsList.filter(
      eachObj => eachObj.category === tabId,
    )
    return filterdList
  }

  render() {
    const newList = this.updatedList()
    return (
